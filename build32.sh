...
configurestr='bash configure --with-freetype-include='$(pwd)'/third/freetype-2.9.1/src/include --with-freetype-lib='$(pwd)'/third/freetype-2.9.1/lib  --with-boot-jdk='$(pwd)'/third/openjdk-11.0.1_windows-x64_bin --disable-warnings-as-errors --with-toolchain-version=2017 --with-target-bits=32'
cd src
echo $configurestr
${configurestr}
echo "make all"
